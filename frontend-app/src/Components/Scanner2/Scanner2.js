...
export default function Scanner2() {
    const API_URL = "http://localhost:5083/api/scanner2";
    ...
    const validateForm = () => {
        ...
        if (isEmpty(formData.scanner2Brand)) newErrors.scanner2Brand = "Brand is required";
        if (isEmpty(formData.scanner2Model)) newErrors.scanner2Model = "Model is required";
        if (isEmpty(formData.scanner2Type)) newErrors.scanner2Type = "Type is required";
        if (isEmpty(formData.scanner2Resolution)) newErrors.scanner2Resolution = "Resolution is required";
        if (isEmpty(formData.scanner2AssetTag)) newErrors.scanner2AssetTag = "Asset Tag is required";
        if (isEmpty(formData.purchaseDate)) newErrors.purchaseDate = "Purchase Date is required";
        if (isEmpty(formData.scanner2Location)) newErrors.scanner2Location = "Location is required";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                ...
                alert("✅ Scanner2(ICR Scanner) updated successfully");
            } else {
                await axios.post(API_URL, payload);
                alert("✅ Scanner2(ICR Scanner) added successfully");
            }
    ...
    const handleEdit = (p) => {
        ...
        setFormData({
            ...
            scanner2Location: p.scanner2Location,
            remarks: p.remarks,
            damageReasonInput: "",
        });
        setShowForm(true);
    ...
    const exportToPDF = () => {
        ...
        autoTable(doc, {
            ...
            body: items.map((p, i) => [
                ...
                p.scanner2Model,
                p.scanner2Type,
                p.scanner2Resolution,
                p.scanner2AssetTag,
                p.scanner2Location,
            ]),
        });

        doc.save(`scanner2_${Date.now()}.pdf`);
    };

    return (
        <div className="scanner2-page container-fluid mt-4 mb-5 px-2">
            <h3 className="text-center mb-4">📠 Scanner2(ICR Scanner)</h3>
            ...
            {showForm && (
                <form className="card p-3 shadow-sm mb-4" onSubmit={handleSubmit}>
                    <h5 className="text-center fw-bold mb-3">
                        {editingId ? "✏️ Edit scanner2(ICR Scanner)" : "🆕 Add scanner2(ICR Scanner)"}
                    </h5>
                    ...
                    <div className="row g-3">
                        <div className="col-md-4">
                            ...
                            <input
                                ...
                                className={`form-control ${errors.scanner2Brand ? "is-invalid" : ""}`}
                            />
                            {errors.scanner2Brand && <div className="text-danger small">{errors.scanner2Brand}</div>}
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input
                                type="text"
                                name="scanner2Model"
                                value={formData.scanner2Model}
                                onChange={handleChange}
                                className={`form-control ${errors.scanner2Model ? "is-invalid" : ""}`}
                            />
                            {errors.scanner2Model && <div className="text-danger small">{errors.scanner2Model}</div>}
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <select
                                name="scanner2Type"
                                value={formData.scanner2Type}
                                onChange={handleChange}
                                className={`form-select ${errors.scanner2Type ? "is-invalid" : ""}`}
                            >
                            ...
                            {errors.scanner2Type && <div className="text-danger small">{errors.scanner2Type}</div>}
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <select
                                ...
                                value={formData.scanner2Resolution}
                                onChange={handleChange}
                                className={`form-select ${errors.scanner2Resolution ? "is-invalid" : ""}`}
                            >
                            ...
                            {errors.scanner2Resolution && <div className="text-danger small">{errors.scanner2Resolution}</div>}
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input
                                type="text"
                                name="scanner2Location"
                                value={formData.scanner2Location}
                                onChange={handleChange}
                                className={`form-control ${errors.scanner2Location ? "is-invalid" : ""}`}
                            />
                            {errors.scanner2Location && <div className="text-danger small">{errors.scanner2Location}</div>}
                        </div>
            ...
            {loading ? (
                ...
                <div className="alert alert-info text-center">No scanner2(icr scanners) records found</div>
            ) : (
                <>
                            ...
                            <tbody>
                                {items.map((p, i) => (
                                    <tr key={p.id}>
                                        ...
                                        <td>{p.scanner2Brand}</td>
                                        <td>{p.scanner2Model}</td>
                                        <td>{p.scanner2Type}</td>
                                        <td>{p.scanner2Resolution}</td>
                                        <td>{p.scanner2AssetTag}</td>
                                        <td>{p.scanner2Location}</td>
